            ...
            <form action="#" method="POST">
                <div class="grid-expediente">
                    ...
                    <div class="expeB">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="enfermera" class="form-control" id="floatingInput" placeholder="medico">
                ...
                <div class="entrar d-grid gap-2">
                    <button class="btn btn-success p-2" type="submit"><i class="bi bi-arrow-repeat px-2"></i>Guardar Expediente Clinico</button>
                </div>
            </form>
        </div>
    </div>
